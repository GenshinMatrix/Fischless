...
public static class LazyProtocol
{
    ...
    public const string ProtocolName = "genshinlazy";
    ...
    public static async Task<string> GetVaildPathAsync()
    {
        ...
        if (keyScheme != null)
        {
            ...
            if (keyCommand?.GetValue(string.Empty) is string pathRegistered)
            {
                ...
                {
                    if (await LazyVerification.VerifyAssembly(exe))
                    {
                        return exe;
                    }
                }
    ...
    public static void Register()
    {
        ...
        keyScheme.SetValue(string.Empty, $"GenshinLazy");
